/*:
@target MZ
@plugindesc Easing movement for Plugin Developers
...
Usage:
Move object to x,y
> Easings.move(object, targetX, targetY, duration, fnName="linear")

<object> is a valid object that has x and y parameter (Windows/Sprites)
<fnName> is a valid function name, can be omitted (default: linear)

Ex: 
Easings.move(window, 100, 100, 60)
Easings.move(window, 100, 100, 60, "outSine")

update object's property
> Easings.updateProp(object, propname, value, duration, fnName="linear")

Ex: 
Easings.updateProp(sprite, "opacity", 255, 60)
Easings.updateProp(sprite, "opacity", 255, 60, "inSine")
